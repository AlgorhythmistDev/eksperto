...
final class NotesSearchComponent extends DatatableComponent
{
    #[LiveProp(writable: true, url: true)]
    public string $sort = 'n.createdAt';
    #[LiveProp(writable: true, url: true)]
    public string $direction = 'DESC';

    #[LiveProp(writable: false)]
    public ?string $rowTemplateFile = "admin/note/_row.html.twig";

    #[Override]
    public function getQueryBuilder(): QueryBuilder
    {
        return $this->entityManager->getRepository(Note::class)->createQueryBuilder('n');
    }
    ...
    public function getTableBuildData(): array
    {
        return [
            'headers' => [
                ...
                [
                    'label' => $this->translator->trans('Pinned'),
                ],
                'n.createdAt' => [
